      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-[#1a1a1a] p-6 rounded-lg mb-8 border border-[#333]">
            ...
            <p className="text-[#ccc] mb-4">Topic drift controls session plan, consent worksheet, and slides.</p>
            <Link href="/case-studies/savings-calculator/materials" className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-6 rounded-lg">View Materials</Link>
          </div>
