          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333] mb-8">
            ...
            <ul className="space-y-3 text-[#ccc]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Session Plan:</strong> <Link href="/educators/resources/ai-trust-healthcare-session-plan" className="text-purple-400 hover:text-purple-300">Topic Drift – Session Plan</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Users className="text-purple-400" size={18} />
                <span>
                  <strong>Worksheet:</strong> <Link href="/educators/resources/ai-trust-healthcare-worksheet" className="text-purple-400 hover:text-purple-300">Topic Drift – Worksheet</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Presentation className="text-purple-400" size={18} />
                <span>
                  <strong>Slides:</strong> <Link href="/educators/downloads" className="text-purple-400 hover:text-purple-300">Topic Drift – Slides (Coming Soon)</Link>
                </span>
              </li>
            </ul>
