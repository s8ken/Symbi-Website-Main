      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-8">
          ...
          <p className="text-xl text-[#ccc]">
            A first-person case study implementing the SYMBI framework with receipts across Reality, Trust, Ethics, Resonance, and Parity.
          </p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-6 mb-8">
            ...
            <p className="text-[#ccc]">
              Comparative case study with implementation log analysis and receipts. Preliminary evidence; personal perspective accompanies verifiable artifacts; independent validation and controlled experiments pending.
            </p>
          </div>
