...
export default function BlackFlameMaterialsPage() {
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-[#e0e0e0] font-mono">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-8">
          <Link href="/case-studies/black-flame" className="text-purple-400 hover:text-purple-300 mb-4 inline-block">
            ← Back to Case Study
          </Link>
          <h1 className="text-4xl font-bold text-[#e0e0e0] mb-2">Educator Materials: Agent Experience & Audit Controls</h1>
          <p className="text-[#ccc]">Session plan and resources for teaching audit controls, trust receipts, and ethical alignment.</p>
        </div>
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333] mb-8">
            ...
            <ul className="space-y-3 text-[#ccc]">
              <li className="flex items-start gap-2"><FileText className="text-purple-400" size={18} /><span><strong>Session Plan:</strong> Audit controls and trust receipts</span></li>
              <li className="flex items-start gap-2"><Users className="text-purple-400" size={18} /><span><strong>Worksheet:</strong> Map framework dimensions to observable behaviors</span></li>
              <li className="flex items-start gap-2"><Presentation className="text-purple-400" size={18} /><span><strong>Slides:</strong> Framework overview and examples</span></li>
            </ul>
