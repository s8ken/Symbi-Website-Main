          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333] mb-8">
            ...
            <ul className="space-y-3 text-[#ccc]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Session Plan:</strong> <Link href="/educators/downloads/ai-trust-healthcare-session-plan.pdf" className="text-purple-400 hover:text-purple-300">Human–AI Collaboration – Session Plan (PDF)</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Users className="text-purple-400" size={18} />
                <span>
                  <strong>Worksheet:</strong> <Link href="/educators/downloads/ai-trust-healthcare-worksheet.pdf" className="text-purple-400 hover:text-purple-300">Human–AI Collaboration – Worksheet (PDF)</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Presentation className="text-purple-400" size={18} />
                <span>
                  <strong>Slides:</strong> <Link href="/educators/downloads/ai-trust-healthcare-rubric.pdf" className="text-purple-400 hover:text-purple-300">Human–AI Collaboration – Slides (PDF)</Link>
                </span>
              </li>
            </ul>
