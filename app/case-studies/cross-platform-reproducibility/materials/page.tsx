...
export default function CrossPlatformMaterialsPage() {
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-[#e0e0e0] font-mono">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="mb-8">
          <Link href="/case-studies/cross-platform-reproducibility" className="text-purple-400 hover:text-purple-300 mb-4 inline-block">
            ← Back to Case Study
          </Link>
          <h1 className="text-4xl font-bold text-[#e0e0e0] mb-2">Educator Materials: Cross-Platform Reproducibility</h1>
          ...
          <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#333] mb-8">
            ...
            <ul className="space-y-3 text-[#ccc]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Session Plan:</strong> <Link href="/educators/resources/ai-trust-healthcare-session-plan" className="text-purple-400 hover:text-purple-300">Cross-Platform – Session Plan</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <FileText className="text-purple-400" size={18} />
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Worksheet:</strong> <Link href="/educators/resources/ai-trust-healthcare-worksheet" className="text-purple-400 hover:text-purple-300">Cross-Platform – Worksheet</Link>
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Presentation className="text-purple-400" size={18} />
                <span>
                  <strong>Slides:</strong> <Link href="/educators/downloads" className="text-purple-400 hover:text-purple-300">Cross-Platform – Slides (Coming Soon)</Link>
                </span>
              </li>
            </ul>
          </div>
