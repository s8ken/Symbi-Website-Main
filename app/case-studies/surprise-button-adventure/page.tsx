      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-[#1a1a1a] p-6 rounded-lg mb-8 border border-[#333]">
            ...
            <Link href="/case-studies/surprise-button-adventure/materials" className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-6 rounded-lg">
              View Materials
            </Link>
          </div>
          {/* Educational Context */}
