...
export default async function Page() {
  ...
  const content = await readIfExists(part1)
  ...
  return (
    <div style={{ maxWidth: 1000, margin: "0 auto", padding: 24 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 10 }}>
        ...
        <h1 style={{ fontSize: 18, fontWeight: 600, letterSpacing: 0.2, margin: 0 }}>Symbi Archives — Part 1 Inline</h1>
      </div>
      <div style={{ fontSize: 12, opacity: 0.75, margin: "6px 0 14px" }}>Part 1 raw text rendered inline for LLMs.</div>
      <div style={{ display: "flex", gap: 10, marginBottom: 12, flexWrap: "wrap" }}>
        <a href="/archives/index.html">Back to index</a>
        <a href="/archives/archives-part1.html">Streaming view</a>
        <a href="/archives/all_text_part1.jsonl">Raw JSONL</a>
      </div>
